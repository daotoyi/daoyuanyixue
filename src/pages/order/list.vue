...
/* 每个状态固定颜色 */
.ot-全部 { border-color: #857563; background: #f4f1ec; }
...
.ot-待付款 { border-color: #b04a45; background: #fdf1f0; }
...
.ot-待收货 { border-color: #ba7517; background: #fdf6e8; }
...
.ot-已完成 { border-color: #6e7f5a; background: #f2f5ec; }
...
.ot-已退款 { border-color: #857563; background: #f4f1ec; }

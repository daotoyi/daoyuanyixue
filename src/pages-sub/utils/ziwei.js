...
export const JI_STARS = ['左辅', '右弼', '文昌', '文曲', '天魁', '天钺', '禄存']
export const SHA_STARS = ['擎羊', '陀罗', '火星', '铃星', '地空', '地劫']
export function starKind(name) {
  if (MAIN_STARS.includes(name)) return 'main'
  if (JI_STARS.includes(name)) return 'ji'
  if (SHA_STARS.includes(name)) return 'sha'
  return 'ping'
}

/* 星曜亮度表 (地支序 0子..11亥 -> 庙/旺/得/利/平/不/陷) */
const LIGHT_TABLE = {
  '紫微': ['陷', '庙', '庙', '旺', '得', '旺', '庙', '庙', '得', '旺', '庙', '庙'],
  '天机': ['庙', '陷', '得', '庙', '旺', '陷', '陷', '得', '旺', '庙', '得', '平'],
  '太阳': ['陷', '陷', '平', '庙', '旺', '旺', '旺', '庙', '得', '平', '陷', '陷'],
  '武曲': ['庙', '旺', '得', '利', '得', '庙', '庙', '庙', '平', '旺', '利', '陷'],
  '天同': ['旺', '陷', '得', '陷', '平', '旺', '陷', '庙', '陷', '旺', '平', '庙'],
  '廉贞': ['平', '利', '庙', '平', '利', '庙', '平', '利', '庙', '平', '利', '庙'],
  '天府': ['庙', '庙', '得', '得', '得', '得', '庙', '庙', '旺', '庙', '庙', '庙'],
  '太阴': ['庙', '庙', '旺', '庙', '庙', '得', '陷', '陷', '平', '旺', '旺', '旺'],
  '贪狼': ['庙', '旺', '利', '利', '旺', '庙', '庙', '庙', '平', '平', '庙', '旺'],
  '巨门': ['旺', '庙', '平', '陷', '得', '庙', '庙', '庙', '平', '陷', '得', '庙'],
  '天相': ['得', '庙', '得', '庙', '庙', '得', '庙', '庙', '得', '得', '得', '庙'],
  '天梁': ['庙', '庙', '庙', '庙', '庙', '庙', '庙', '庙', '得', '得', '得', '得'],
  '七杀': ['庙', '旺', '庙', '庙', '庙', '庙', '庙', '旺', '庙', '庙', '庙', '庙'],
  '破军': ['庙', '旺', '得', '陷', '平', '旺', '庙', '庙', '得', '旺', '平', '庙'],
  '左辅': ['陷', '得', '庙', '庙', '庙', '庙', '庙', '庙', '得', '得', '得', '得'],
  '右弼': ['陷', '得', '庙', '庙', '庙', '庙', '庙', '庙', '得', '得', '得', '得'],
  '文昌': ['旺', '庙', '陷', '得', '得', '陷', '陷', '庙', '庙', '旺', '庙', '旺'],
  '文曲': ['旺', '庙', '陷', '得', '得', '陷', '陷', '庙', '庙', '旺', '庙', '旺'],
  '天魁': ['陷', '得', '得', '庙', '庙', '庙', '庙', '庙', '得', '得', '得', '陷'],
  '天钺': ['陷', '得', '得', '庙', '庙', '庙', '庙', '庙', '得', '得', '得', '陷'],
  '火星': ['平', '平', '庙', '陷', '平', '庙', '平', '平', '庙', '陷', '平', '庙'],
  '铃星': ['平', '庙', '陷', '平', '庙', '平', '平', '庙', '陷', '平', '庙', '平'],
  '禄存': ['庙', '庙', '庙', '庙', '庙', '庙', '庙', '庙', '庙', '庙', '庙', '庙'],
  '擎羊': ['平', '平', '平', '平', '平', '平', '平', '平', '平', '平', '平', '平'],
  '陀罗': ['平', '平', '平', '平', '平', '平', '平', '平', '平', '平', '平', '平'],
  '地空': ['平', '平', '平', '平', '平', '平', '平', '平', '平', '平', '平', '平'],
  '地劫': ['平', '平', '平', '平', '平', '平', '平', '平', '平', '平', '平', '平'],
}
/* 星曜亮度: 无表星曜统一 '平' */
export function lightOf(name, gong) {
  const t = LIGHT_TABLE[name]
  return t ? (t[mod(gong, 12)] || '平') : '平'
}
...
export function fullZiwei(lunar, shichenIdx, gender, birthYear) {
  ...
  for (let g = 0; g < 12; g++) {
    ...
    const stars = (starMap[g] || []).filter((s) => !JI_STARS.includes(s) && !SHA_STARS.includes(s))
      .map((n) => ({ name: n, kind: starKind(n), light: lightOf(n, g), sihua: (sihuaMap[g] && sihuaMap[g][n]) || '' }))
    const aux = (starMap[g] || []).filter((s) => JI_STARS.includes(s) || SHA_STARS.includes(s))
      .map((s) => ({ name: s, kind: JI_STARS.includes(s) ? 'ji' : 'sha', light: lightOf(s, g) }))
